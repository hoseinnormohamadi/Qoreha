                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="float-right">
                                <form method="GET" action="/panel/Menu/All">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="table-links">
                                                    <a href="/panel/Menu/Edit/{{$menu->id}}">ویرایش</a>
                                                    <div class="bullet"></div>
                                                    <a href="/panel/Menu/Delete/{{$menu->id}}" class="text-danger">
                                                        حذف
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                {{\Verta::instance($menu->created_at)->format('Y/m/d')}}
                                            </td>
