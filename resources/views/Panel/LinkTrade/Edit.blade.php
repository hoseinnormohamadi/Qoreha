...
@section('content')
    <section class="section">
        <ul class="breadcrumb breadcrumb-style ">
            ...
            <li class="breadcrumb-item">تبادل لینک</li>
            <li class="breadcrumb-item">ویرایش لینک</li>
        </ul>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>لینک را ویرایش کنید.</h4>

                        </div>
                        <div class="card-body">
                            <form method="POST" action="/panel/LinkTrade/Edit/{{$Link->id}}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea id="mytextarea" name="Description">{{$Link->Description}}</textarea>
                                    </div>
                                </div>
