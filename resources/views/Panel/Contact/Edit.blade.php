...
@section('content')
    <section class="section">
        <ul class="breadcrumb breadcrumb-style ">
            ...
            <li class="breadcrumb-item">ویرایش پیام</li>
        </ul>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>پیام را ویرایش کنید.</h4>

                        </div>
                        <div class="card-body">
                            <form method="POST" action="/panel/Contact/Edit/{{$Contact->id}}">
                                @method('PUT')
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7 ">
                                        <input type="text"
                                               ...
                                               name="PhoneNumber" value="{{$Contact->PhoneNumber}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea id="mytextarea" name="Text">{{$Contact->Text}}</textarea>
                                    </div>
                                </div>
