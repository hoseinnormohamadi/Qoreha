...
@section('content')
    <section class="section">
        <ul class="breadcrumb breadcrumb-style ">
            ...
            <li class="breadcrumb-item">ایجاد زیر دسته بندی</li>
        </ul>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>زیر دسته بندی جدیدی را ایجاد کنید.</h4>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('SubCategory.Create')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="Parent">
                                            ...
                                            @foreach($Tags as $tag)
                                                <option name="Parent" value="{{$tag->id}}" >{{$tag->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group  row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <button class="btn btn-primary">ایجاد زیر دسته بندی</button>
                                    </div>
                                </div>
                            </form>
                        </div>
