                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-info @if(request('Mode') == 'DeActive') active @endif" href="?Mode=DeActive">غیر فعال<span
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="table-links">
                                                    ...
                                                    <a href="/panel/Ads/Delete/{{$Ad->id}}" class="text-danger">
                                                        حذف
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                {{\Verta::instance($Ad->created_at)->format('Y/m/d')}}
                                            </td>
                                            <td>
                                                {{\Verta::instance($Ad->ExpireDate)->format('Y/m/d')}}
                                            </td>
