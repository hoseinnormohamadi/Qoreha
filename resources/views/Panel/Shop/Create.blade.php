                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>کالا جدیدی ایجاد کنید</h4>

                        </div>
                        <div class="card-body">
                            <form method="POST" action="/panel/Shop/Add" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7 ">
                                        <input type="text"
                                               ...
                                               name="Diameter" value="{{old('Diameter')}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="Category">
                                            ...
                                            @foreach($Tags as $Tag)
                                            <option name="Category" @if(old('Category') == $Tag->id) selected @endif value="{{$Tag->id}}">{{$Tag->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="Status">
                                            ...
                                            <option name="Status" @if(old('Status') == 'Available') selected @endif value="Available">موجود</option>
                                            <option name="Status" @if(old('Status') == 'UnAvailable') selected @endif value="UnAvailable">ناموجود</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="Type">
                                            ...
                                            <option name="Type" @if(old('Type') == 'Sell') selected @endif value="Sell">فروش</option>
                                            <option name="Type" @if(old('Type') == 'Rent') selected @endif value="Rent">اجاره</option>
                                        </select>
                                    </div>
                                </div>
