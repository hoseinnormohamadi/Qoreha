            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/panel/Shop/Category/Edit/{{$Tag->id}}">
                                @method('PUT')
                                @csrf
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7 ">
                                        <input type="text" class="form-control @error('name') border border-danger @enderror" name="name" value="{{$Tag->name}}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
