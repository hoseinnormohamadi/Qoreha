...
function initTowhub() {
 ...
 // date picker------------------
    ...
    $.ajaxChimp.translations.eng = {
        submit: "در حال ارسال ......",
        0: '<i class="fa fa-check"></i> به زودی با هم در ارتباط خواهیم بود!',
        1: '<i class="fa fa-warning"></i> شما باید یک آدرس ایمیل معتبر وارد کنید.',
        2: '<i class="fa fa-warning"></i> آدرس ایمیل معتبر نیست.',
        3: '<i class="fa fa-warning"></i> آدرس ایمیل معتبر نیست.',
        4: '<i class="fa fa-warning"></i> آدرس ایمیل معتبر نیست.',
        5: '<i class="fa fa-warning"></i> آدرس ایمیل معتبر نیست.'
    };
    //   Video------------------
 ...
 // scroll animation ------------------
    ...
    $(".act-hiddenpanel").on("click", function () {
        $(this).toggleClass("active-hidden-opt-btn").find("span").text($(this).find("span").text() === 'بستن' ? 'گزینه های بیشتر' : 'بستن');
    ...
    $(".show-hidden-map").on("click", function (e) {
        e.preventDefault();
        $(".show-hidden-map").find("span").text($(".show-hidden-map span").text() === 'بستن' ? 'روی نقشه' : 'بستن');
